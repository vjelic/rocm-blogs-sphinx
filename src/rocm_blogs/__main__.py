...
def main():
    ...
    parser.add_argument(
        "--metadata", action="store_true", help="Run metadata generation"
    )
    parser.add_argument(
        "--blogs-dir", type=str, help="Path to blogs directory (optional)"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    try:
        # Parse command line arguments first to check if we're just showing
        # version
